        ...
        <div class="bg-white rounded-lg shadow-sm border border-[#CBD5E1] p-6">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">A descriptive name for the template</p>
                </div>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="2"
                              class="w-full px-4 py-2.5 border border-[#CBD5E1] rounded-lg focus:ring-2 focus:ring-[#1a425f] focus:border-[#1a425f]  @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1  text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <textarea id="body_html" name="body_html" rows="12" required
                              class="w-full px-4 py-2.5 border border-[#CBD5E1] rounded-lg focus:ring-2 focus:ring-[#1a425f] focus:border-[#1a425f] font-mono @error('body_html') border-red-500 @enderror">{{ old('body_html') }}</textarea>
                    @error('body_html')
                        <p class="mt-1  text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <textarea id="body_text" name="body_text" rows="8"
                              class="w-full px-4 py-2.5 border border-[#CBD5E1] rounded-lg focus:ring-2 focus:ring-[#1a425f] focus:border-[#1a425f] font-mono @error('body_text') border-red-500 @enderror">{{ old('body_text') }}</textarea>
                    @error('body_text')
                        <p class="mt-1  text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Plain text version (optional, will be auto-generated from HTML if not provided)</p>
                </div>
            </div>
        </div>
